...
(define-public llvm
  (let* ((commit "9df0977d9409b093156ebbd8e1ac99bc32b9eb39")
         (revision "1")
...
(define-public clang-runtime
  (let* ((commit "35d20abb3eda4a6f259a5517ca76e382d470107c")
	 (revision "1")
	 (version (git-version "7.0" revision commit)))
    (package
      (name "clang-runtime")
...
(define-public clang
  (let* ((commit "a5d91b277b50f9d1b7d62c507b36d798761e2a57")
	 (revision "1")
	 (version (git-version "7.0" revision commit)))
    (package
      (name "clang")
