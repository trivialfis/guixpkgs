...
(define-public libopenshot
  ...
  (package
    ...
    (source (origin
	      ...
	      (uri
	       (string-append
		"https://github.com/OpenShot/libopenshot/archive/v"
		version ".tar.gz"))
	      (sha256
	       (base32
		"0iax6sxky4as8iqy1d9iirz8nk5gy47krk5ir7nydh656dj71c59"))
    ...
    (inputs
     `(("ffmpeg" ,ffmpeg)
       ...
       ("zeromq" ,zeromq)))
    (home-page "http://www.openshot.org/")
    (synopsis "delivering high quality video editing, animation, and playback
solutions")
    (description "OpenShot Library (libopenshot) is an open-source project
...
(define-public openshot
  ...
  (package
    ...
    (source (origin
	      ...
	      (uri
	       (string-append
		"https://github.com/OpenShot/openshot-qt/archive/v"
		version ".tar.gz"))
	      (sha256
	       (base32
		"0iax6sxky4as8iqy1d9iirz8nk5gy47krk5ir7nydh656dj71c59"))
    ...
    (inputs
     `(("ffmpeg" ,ffmpeg)))
    (home-page "http://www.openshot.org/")
    (synopsis "video editing application")
    (description "high quality video editing and animation solutions.")
    (license license:gpl3+)))
